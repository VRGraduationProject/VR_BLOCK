...
public class OVRPlayerController : MonoBehaviour
{
	...
	public virtual void UpdateMovement()
	{
        ...
        //회전, 위 아래
        if (Input.GetButton("Xiaomi Rotate Left"))
            euler.y -= 1;

        if (Input.GetButton("Xiaomi Rotate Right"))
            euler.y += 1;

        //if (Input.GetButton("Xiaomi button Down"))
        //    euler.x -= 1;
        //if (Input.GetButton("Xiaomi button Up"))
        //    euler.x += 1;
		...
		if (!SkipMouseRotation)
			euler.y += Input.GetAxis("Mouse X") * rotateInfluence * 3.25f; //horizontal 회전
#endif
	...
	public bool Jump()
	{
        ...
        MoveThrottle = Vector3.Lerp(MoveThrottle,new Vector3(0, transform.lossyScale.y * JumpForce, 0),Time.deltaTime * 100.0f );
